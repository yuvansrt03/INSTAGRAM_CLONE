    ...
    <div className='left_panel_container'>
        ...
        <div className="left_panel_profile">
          <div className="left_panel_profile_header">
            ...
            <img className="left_panel_profile_image" src="https://images.pexels.com/photos/1040880/pexels-photo-1040880.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"></img>
            <div className="left_panel_profile_name">Magnus Carlsen</div>
            <div className="left_panel_profile_address">California, US</div>
