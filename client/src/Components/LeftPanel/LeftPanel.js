    ...
    <div className='left_panel_container'>
        ...
        <div className="left_panel_profile">
          ...
          <div className="left_panel_screens">
            <button className='left_panel_screen_type'><div className='isactivebar'></div><FontAwesomeIcon icon={faHouse} className='pr-3 text-lg pl-7 isactivecolor'/><span className='text-sm font-bold isactivecolor'>Feed</span></button>
          </div>
        </div>
